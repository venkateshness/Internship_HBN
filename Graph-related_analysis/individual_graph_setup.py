...
for i in range(1, 25):
    if os.path.isfile(
        f"/users2/local/Venkatesh/HBN/CPAC_preprocessed/sub-{subjects[i]}_ses-1/functional_to_standard/_scan_rest/_selector_CSF-2mmE-M_aC-CSF+WM-2mm-DPC5_M-SDB_P-2_BP-B0.01-T0.1_C-S-1+2-FD-J0.5/bandpassed_demeaned_filtered_antswarp.nii.gz"
    ):
