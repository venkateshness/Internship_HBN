...
for i in range(2):
        ...
        plt.legend()
        plt.plot(range(143),mean_t1[:143],color='r')
        plt.fill_between(range(143),bottom1[:143],top1[:143], color='r', alpha=.1,label='High ISC')
        plt.plot(range(143),mean_t2[:143],color='b')
        plt.fill_between(range(143),bottom2[:143], top2[:143], color='b', alpha=.1,label='Low ISC')
        plt.ylabel('gPSDs')
        plt.xlabel('Eigen values')
        plt.title('Graph PSD for both the conditions while subject being the variability for the low freq')
        plt.xticks(ticks=[0,35,70,105,140],labels=["0.04","0.25","0.5","0.75","1"],rotation='horizontal')
        #plt.axvline(x=250, linestyle = '--', color='g')
...
for i in range(2):
        ...
        plt.legend()
        plt.plot(range(143,359),mean_t1[143:],color='r')
        plt.fill_between(range(143,359),bottom1[143:],top1[143:], color='r', alpha=.1,label='High ISC')
        plt.plot(range(143,359),mean_t2[143:],color='b')
        plt.fill_between(range(143,359),bottom2[143:], top2[143:], color='b', alpha=.1,label='Low ISC')
        plt.ylabel('gPSDs')
        plt.xlabel('Eigen values')
        plt.title('Graph PSD for both the conditions while subject being the variability for the high freq')
        plt.xticks(ticks=np.arange(143,360,44),labels=["1","1.1","1.2","1.3","1.4"],rotation='horizontal')
        #plt.axvline(x=250, linestyle = '--', color='g')
